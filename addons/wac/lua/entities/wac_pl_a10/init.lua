...
function ENT:PhysicsUpdate(ph)
	...
	if tb.rotor2 then
		...
		tb.rotor2.phys:AddAngleVelocity(Vector(0,0,tb.engineRpm*30 + throttle*tb.engineRpm*20)*tb.rotorDir*phm)
		tb.rotor2.phys:AddAngleVelocity(Vector(0,0,-brake + lvel.x*lvel.x/500000)*tb.rotorDir*phm)
	end
end

function ENT:addRotors(tb)
	tb = tb and self:GetTable()
