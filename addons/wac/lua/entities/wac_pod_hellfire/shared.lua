...
ENT.Damage = MG_Vehicles.Config:GetDamage("heli_t1", "Hellfire")
ENT.Ammo = MG_Vehicles.Config:GetAmmo("heli_t1", "Hellfire")
ENT.FireRate = MG_Vehicles.Config:GetFireRate("heli_t1", "Hellfire")
ENT.Sequential = true
ENT.MaxRange = 10000
