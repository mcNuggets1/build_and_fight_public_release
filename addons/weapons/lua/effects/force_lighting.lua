...
local segments = {}
local tiem = 0.2
local function DrawBeams(depth, sky)
...
hook.Add("PostDrawTranslucentRenderables", "lightsaber_drawbeams", DrawBeams)
...
function EFFECT:Init(data)
	...
	table.insert(segments, {
		segs = GenerateLightingSegs(pos, ent, math.random(10, 20), pos:Distance(ent:GetPos()) / 48),
