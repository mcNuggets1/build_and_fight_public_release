...
if SERVER then
	...
	CreateConVar("sv_hoverboard_cansteal", 1, { FCVAR_NOTIFY, FCVAR_ARCHIVE })
...
if CLIENT then
	language.Add("hoverboard", "Hoverboard")
	language.Add("hoverboard_hull", "Hoverboard")
	language.Add("hoverboard_avatar", "Hoverboard")

	killicon.Add("hoverboard", "modulus_hoverboard/deathicon", Color(255, 80, 0, 255))
	killicon.AddAlias("hoverboard_hull", "modulus_hoverboard")
	killicon.AddAlias("hoverboard_avatar", "modulus_hoverboard")
end
