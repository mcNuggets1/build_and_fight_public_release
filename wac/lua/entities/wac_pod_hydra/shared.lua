...
ENT.Damage = MG_Vehicles.Config:GetDamage("heli_t1", "Hydra 70")
ENT.Ammo = MG_Vehicles.Config:GetAmmo("heli_t1", "Hydra 70")
ENT.FireRate = MG_Vehicles.Config:GetFireRate("heli_t1", "Hydra 70")
ENT.Sequential = true
ENT.Pods = {
...
function ENT:Initialize()
	...
	self.sounds = {fire = CreateSound(self, "HelicopterVehicle/MissileShoot.mp3")}
end
