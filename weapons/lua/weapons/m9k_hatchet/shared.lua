...
SWEP.SwingSound1 = "Hatchet.Swing"
SWEP.HitSound1 = "Hatchet.HitWorld"
SWEP.FleshSound1 = "Hatchet.HitFlesh"
...
SWEP.ViewPunch1 = nil
SWEP.ViewPunchThrow = Angle(-6, 0, 0)
...
SWEP.ThrowAnimations = {"Attack_Charge_End"}

SWEP.DrawSound = "Hatchet.Draw"
...
function SWEP:CreateThrownWeapon()
	...
	local mach = ents.Create("m9k_thrown_hatchet")
...
function SWEP:DrawWorldModel()
	...
	pos = pos + (ang:Right() * 1 + ang:Forward() * 3.5 + ang:Up() * -4)
